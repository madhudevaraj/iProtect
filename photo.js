(function() {
	...
	// The code snippet shows you how to access a webcam. Various vendor prefixes
	//might be required. This also requests access to the video stream only, 
	//and not the audio. The default values for either video or audio is false.
	// If the video stream is successfully returned, then  success callback is called otherwise 
	//error callback is executed. The error can have value: PERMISSION_DENIED
	...
	function notifyMe(message) {
		if (message == undefined){
  		...
  		if (!("Notification" in window)) {
  			...
  			var options = {
  				image: '/Users/Madhu/Downloads/300.jpg'
  			}
    			var notification = new Notification(message, options);
    			// notification.image = '/Users/Madhu/Downloads/300.jpg';
